package com.moataz.edge.security
...
class SecretStore(context: Context) {
    private val preferences = context.getSharedPreferences("edge_secrets", Context.MODE_PRIVATE)
    ...
    fun contains(name: String): Boolean = preferences.contains("${name}_data")
    ...
    private companion object {
        ...
        const val KEY_ALIAS = "moataz_edge_master_key_v1"
